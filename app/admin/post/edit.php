...
$other_category = $category->find($data->category_id);
 ...
 <div class="col-2 bg-white position-relative border-bottom border-light" style="height: 650px;">
    ...
    <div class="col-10 d-flex flex-column align-items-center justify-content-center bg-secondary bg-gradient border-bottom border-light">
        ...
        <div class="card p-3 border-0 shadow" style="width:380px;">
            ...
            <?php endif; ?>
            <form method="post" action="../../action/post/update.php"  enctype="multipart/form-data">
                <h4 class="mb-1 text-primary fw-bolder">Edit Post</h4>
                <hr class="mb-3">
                <input type="hidden" name="id" value="<?= $data->id ?>">
                <div class="mb-2">
                    <label for="">title</label>
                    <input type="text" name="title" class="form-control p-1" value="<?= $data->title ?>">
                </div>
                <div class="mb-2">
                    <label for="">content</label>
                    <textarea name="content" id="" cols="30" rows="4" class="form-control"><?= $data->content ?></textarea>
                </div>
                ...
                <div class="mb-2">
                    ...
                    <select name="category_id" id="" class="form-select p-1">
                        ...
                        <?php foreach($other_category as $res): ?>
                ...
                <div class="mb-2">
                    ...
                    <input type="file" class="form-control p-1" name="photo" id="photo" value="<?= $data->photo ?>" style="display:none;">
                    <div class="mt-1 position-relative" id="div" > 
                        <!-- style="display:none;" -->
                        <img src="<?= "../../image/$data->photo" ?>" alt="img" class="form-control" id="img">
